...
**[> Watch short demo](https://www.youtube.com/watch?v=vm_oOghNEYs)**

**Bit** enables you to organize components throughout your source code into shared collections, and share them across projects, applications and teams. You can turn any library into a dynamic collection of individually reusable components, which can be discovered, maintained and used across projects and applications. 

Bit works great for React or Angular components, Node modules, utility functions and more.

* **Turn any existing subset of files into a reusable component** without changing your source code or file structure. **Turn an entire library into a shared collection** of components using simple commands.
